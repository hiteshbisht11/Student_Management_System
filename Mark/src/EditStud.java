 ...
 * @author JainVipray
 */
public class EditStud extends DBConnection {

    /**
     * Creates new form EditStud
     */
    public String ad,yr;
    public EditStud(String adm,String y) {
        ad=adm;yr=y;
        initComponents();
...
*/
    ...
    private void initComponents() {
        ...
        /*
        jLabel6.setFont(new java.awt.Font("MS PGothic", 0, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("SSSMID:");
        jLabel6.setAlignmentX(11.5F);
        jLabel6.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        
        jLabel14.setFont(new java.awt.Font("MS PGothic", 0, 18)); // NOI18N
        ...
        jLabel9.setFont(new java.awt.Font("MS PGothic", 0, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Year:");
        jLabel9.setAlignmentX(11.5F);
        jLabel9.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        
        jLabel17.setFont(new java.awt.Font("MS PGothic", 0, 18)); // NOI18N
        ...
        */
        ...
        dateChooserCombo1.setFormat(2);
        		...
        		String q= "Select * FROM student WHERE adm='"+ad+"' AND sem='"+yr+"'";
			System.out.print(q);
			//String id = "";
			//ResultSet rs;
			try {
				...
				System.out.println("DATA: Nikaalo \n");
                                if(rs1.next()){
                                jTextField1.setText(rs1.getString("adm"));
                                //jTextField2.setText(rs1.getString("sssmid"));
                                jTextField3.setText(rs1.getString("aadhar"));
                                jTextField4.setText(rs1.getString("name"));
                                jTextField5.setText(rs1.getString("father_name"));
                                jTextField6.setText(rs1.getString("mother_name"));
                                jTextField8.setText(rs1.getString("sem"));
                                //jTextField9.setText(rs1.getString("year"));
                                jTextField10.setText(rs1.getString("dob"));
                                jTextField11.setText(rs1.getString("contact"));
                                jTextField12.setText(rs1.getString("gender"));
                                //jTextField13.setText(rs1.getString("caste"));
                                jTextField14.setText(rs1.getString("religion"));
                                //jTextField16.setText(rs1.getString("fee_balance"));
                                jTextField18.setText(rs1.getString("acc"));
                                jTextField17.setText(rs1.getString("ifsc"));
                                }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        String a=jTextField1.getText(),b=jTextField2.getText(),c=jTextField3.getText(),d=jTextField4.getText(),e=jTextField5.getText(),f=jTextField6.getText(),h=jTextField8.getText(),i=jTextField9.getText(),j=jTextField10.getText(),k=jTextField11.getText(),l=jTextField12.getText(),m=jTextField13.getText(),n=jTextField14.getText(),p=jTextField16.getText(),q=jTextField18.getText(),r=jTextField17.getText();
			String q1= "Update student SET adm='"+a+"',aadhar='"+c+"',name='"+d+"', father_name='"+e+"',mother_name='"+f+"',sem='"+h+"', dob='"+j+"',contact='"+k+"',gender='"+l+"',religion='"+n+"',acc='"+q+"',ifsc='"+r+"' WHERE adm='"+ad+"' AND sem='"+yr+"'";
			System.out.print(q1);
			//String id = "";
			//ResultSet rs;
			try {
				int rs=s.executeUpdate(q1);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                /*EditStud e=new EditStud("24");
                e.setVisible(true);
                e.getContentPane().setBackground(new Color(44,62,80));
                Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
                e.setLocation(dim.width/2-e.getSize().width/2, dim.height/2-e.getSize().height/2);
                e.setVisible(true);
                */
            }
        });
