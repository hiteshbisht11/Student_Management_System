...
public class AddStud extends DBConnection {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String a=jTextField1.getText(),c=jTextField3.getText(),d=jTextField4.getText(),e=jTextField5.getText(),f=jTextField6.getText(),h=jTextField8.getText(),j=dateChooserCombo1.getText(),k=jTextField11.getText(),l=jTextField12.getText(),n=jTextField14.getText(),w=jTextField17.getText(),z=jTextField18.getText();
			String q= "INSERT INTO student SET adm='"+a+"',aadhar='"+c+"',name='"+d+"', father_name='"+e+"',mother_name='"+f+"',sem='"+h+"', dob='"+j+"',contact='"+k+"',gender='"+l+"',religion='"+n+"',acc='"+z+"',ifsc='"+w+"'";
			String q1= "INSERT INTO first SET adm='"+a+"',sem='"+h+"'";
			String q2= "INSERT INTO second SET adm='"+a+"',sem='"+h+"'";
			String q3= "INSERT INTO end SET adm='"+a+"',sem='"+h+"'";
			...
			try {
				int rs=s.executeUpdate(q);
                                int rs1=s.executeUpdate(q1);
                                int rs2=s.executeUpdate(q2);
                                int rs3=s.executeUpdate(q3);
